...
public class Treinamento {
    public static void main(String args[]){
        ...
        System.out.println("Treinamento Eigen Face Realizado");
        
        fisherFaces.train(fotos, rotulos);
        eigenfaces.save("src\\recursos\\classificadorFisherFaces.yml");
        System.out.println("Treinamento Fisher Face Realizado");
        
        lbph.train(fotos, rotulos);
        lbph.save("src\\recursos\\classificadorLBPHFaces.yml");
        System.out.println("Treinamento LBPH Face Realizado");
    }
}
